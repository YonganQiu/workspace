    ...
    defaults: {
        ...
        navigator: {
            children: {
                ...
                testplugin: {
                    path: 'cordova/plugin/testplugin'
                }
            }
        },
        Acceleration: {
...
module.exports = {
     ...
     * Elvis Hew added.
     */
    toast: function(msg, longDuaring) {
        exec(null, null, "Notification", "toast", [msg, longDuaring]);
    }
};
...
//file: lib/android/plugin/testplugin.js
define("cordova/plugin/testplugin", function(require, exports, module) {

var exec = require('cordova/exec');

module.exports = {
    toast : function(message) {
        exec(null, null, 'TestPlugin', 'toast', [ message ]);
    },
}
});
