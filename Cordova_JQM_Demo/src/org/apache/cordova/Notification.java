...
public class Notification extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        // Added by Elvis Hew begin.
        if (action.equals("toast")) {
            this.toast(args.getString(0), args.getBoolean(1));
        } else
        // Added by Elvis Hew end.
    ...
    // Elvis Hew begin.
    public void toast(String msg, boolean longDuaring) {
        Toast.makeText(this.cordova.getActivity(), msg,
                longDuaring ? Toast.LENGTH_LONG : Toast.LENGTH_SHORT).show();
    }
    // Elvis Hew end.
    /**
