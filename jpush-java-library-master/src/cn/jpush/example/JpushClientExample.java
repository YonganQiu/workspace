...
public class JpushClientExample {
	...
	private static final String appKey ="c8094b5a661db1ec0a6fae6d";//"57b9ef19d4be5de08df12aa0";	//必填，例如466f7032ac604e02fb7bda89
	
	private static final String masterSecret = "a18a6149fd5a45149c18effe";//"13ac09b17715bd117163d8a1";//必填，每个应用都对应一个masterSecret
...
//		MessageResult msgResult = jpush.sendNotificationWithAppKey(sendNo, msgTitle, msgContent, 0, extra);
		...
		MessageResult msgResult = jpush.sendNotificationWithImei(sendNo, "123456789012347", msgTitle, msgContent);
		//对所有用户发送通知, 更多方法请参考文档
